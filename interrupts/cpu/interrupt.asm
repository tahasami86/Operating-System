...
; Every interrupt
; Further some interrupt only push interupt code on to the stack
; And no error. So push a Dummy error code for the ones which dont
; So the stack can remain consistant for all the interrupt
...
isr14:
    cli
    push byte 14 ; Interupt code CPU Already pushed the error code
    jmp isr_common_stub
